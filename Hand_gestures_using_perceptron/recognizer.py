...
def count(thresholded, segmented):
    ...
    prob = np.argmax(loaded_model.predict(thresholded),axis=-1)
    return prob
...
if __name__ == "__main__":
    ...
    json_file = open('perceptronModel.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    
    #loaded_model = load_model('hand_gestures_1.h5')
    
    
    # load weights into new model
    loaded_model.load_weights("perceptronModelWeights.h5")
